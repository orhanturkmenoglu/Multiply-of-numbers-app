...
public class activity_tasarim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findView();
        setQuestion();
        final MediaPlayer mediaPlayer = MediaPlayer.create(activity_tasarim.this, R.raw.dogru);
        final MediaPlayer hata = MediaPlayer.create(activity_tasarim.this, R.raw.wrong);
    ...
    public void setQuestion(){
        ...
        if (index>15 & sayac==15 ){
            ...
            Intent intent=new Intent(activity_tasarim.this,MainActivity.class);
