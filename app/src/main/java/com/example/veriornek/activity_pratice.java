...
public class activity_pratice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mediaPlayer=MediaPlayer.create(activity_pratice.this,R.raw.dogru);
        final MediaPlayer hata = MediaPlayer.create(activity_pratice.this, R.raw.wrong);
